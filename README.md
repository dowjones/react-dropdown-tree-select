...
Field property from the input data array from which it will be taken `label`

### keyValue

Type: `string`

Field property from the input data array from which it will be taken `value`
...
```js
{
  label,          // optional: Checkbox label, default = label
  value,          // optional: Checkbox value, default = value
...
| [<img src="https://avatars2.githubusercontent.com/u/12486958?v=4" width="100px;" alt="Sergey Kozlov"/><br /><sub><b>Sergey Kozlov</b></sub>](https://github.com/SergeyWebDeveloper)<br />[💻](https://github.com/dowjones/react-dropdown-tree-select/commits?author=SergeyWebDeveloper "Code") [📖](https://github.com/dowjones/react-dropdown-tree-select/commits?author=SergeyWebDeveloper "Documentation") [🤔](#ideas-SergeyWebDeveloper "Ideas, Planning, & Feedback") [⚠️](https://github.com/dowjones/react-dropdown-tree-select/commits?author=SergeyWebDeveloper "Tests") |
