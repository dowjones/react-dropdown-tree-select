...
const getTags = (tags = [], onDelete, readOnly, tagRenderer) =>
  tags.map(tag => {
...
class Input extends PureComponent {
  ...
  render() {
    const { tags, onTagRemove, inputRef, placeholderText = 'Choose...', onFocus, onBlur, disabled, readOnly, tagRenderer } = this.props
