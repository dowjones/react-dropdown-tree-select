    ...
    return (
      <label title={title || label} htmlFor={id}>
        {radioSelect ?
          ...
          <Checkbox name={id} className={cx('checkbox-item', { 'simple-select': simpleSelect })} indeterminate={showPartiallySelected && partial} onChange={this.handleCheckboxChange} {...sharedProps} />}
